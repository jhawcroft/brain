...
static int plug_nl_sentences_get_next_end(void *in_context, char const *in_characters, int in_length, int *out_end_offset, int *out_end_length, nlatts_t *in_atts)
{
